...
checkcodestandardphpmain:
	cd ../$(PROJECT_FOLDER_PLUGIN); php ci/phpcs.phar --standard=ci/ruleset.xml visualcomposer/
checkcodestandardjsmain:
	cd ../$(PROJECT_FOLDER_PLUGIN); yarn lint "public/**/*.js"
checkcodestandardjselements:
	cd ../$(PROJECT_FOLDER_PLUGIN)/devElements; yarn lint
...
checkcodestandardjsaddons:
	cd ../$(PROJECT_FOLDER_PLUGIN)/devAddons; yarn lint
...
fixcodestandardphpmain:
	cd ../$(PROJECT_FOLDER_PLUGIN); php ci/phpcbf.phar --standard=ci/ruleset.xml visualcomposer/
